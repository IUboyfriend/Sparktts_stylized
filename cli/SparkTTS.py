...
class SparkTTS:
    ...
    def _initialize_inference(self):
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(f"{self.model_dir}/LLM",trust_remote_code=True,)
        self.model = AutoModelForCausalLM.from_pretrained(f"{self.model_dir}/LLM",trust_remote_code=True)
